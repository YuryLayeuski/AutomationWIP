...
describe('Creating account thru hamburger menu via Saved Homes on mobile web', function() {
  it('User should be able to create account thru hamburger menu via Saved Homes', function(done) {
    this.timeout(25000);
    ...
    nightmare
      ...
      .wait('#myZSH > a')    
      .click('#myZSH > a')   //click on 'Saved Homes' link
      .wait(1000) 
