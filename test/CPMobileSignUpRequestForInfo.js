...
describe('test mobile CP Sign Up via Request for Info', function() {
  it('User should be able to create account from home detail page via Request for Info with mobile', function(done) {
    this.timeout(25000);
