...
describe('Creating account thru hamburger menu via Watched Homes on mobile web', function() {
  it('User should be able to create account thru hamburger menu via Watched Homes', function(done) {
    this.timeout(25000);
    ...
    nightmare
      ...
      .wait('#myZWH > a')    
      .click('#myZWH > a')   //click on 'Watched Homes' link
      .wait(1000) 
